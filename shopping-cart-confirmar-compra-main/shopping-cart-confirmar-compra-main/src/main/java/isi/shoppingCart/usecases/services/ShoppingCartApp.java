...
public class ShoppingCartApp {
    ...
    public ShoppingCartApp() {
        ...
        eliminarProductoUseCase = new EliminarProductoUseCase(productRepository, cartRepository);
    ...
    public ShoppingCartApp(ProductRepository productRepository,
                           ...
                           ConfirmarCompraUseCase confirmarCompraUseCase, EliminarProductoUseCase eliminarProductoUseCase) {
    ...
    public OperationResult addProductToCart(int productId) { return agregarProductoAlCarritoUseCase.execute(productId);}
    ...
    public OperationResult deleteProduct(int productId) { return eliminarProductoUseCase.execute(productId);}
}
